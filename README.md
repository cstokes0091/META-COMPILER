...
#                           DISPATCH_HINTS, verification/{hook_id}_spec.yaml +
...
# .github/agents/ palette (implementer, reviewer, researcher).
...
#   implementer/reviewer/researcher agents populate executions/v{N}/work/
meta-compiler phase4-finalize
...
# Inspect planner-provided runnable acceptance specs consumed during Stage 4
ls workspace-artifacts/scaffolds/v1/verification/*_spec.yaml
